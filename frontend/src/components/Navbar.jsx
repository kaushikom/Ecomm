        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-4">
            <NavLink
              ...
              className={({isActive}) => 
                isActive 
                  ? "bg-slate-800 min-w-[60px] text-center text-slate-300 px-2 py-2 text-md font-medium rounded-md hover:text-gray-50"
                  : "px-2 py-2 text-md font-medium text-gray-600 rounded-md hover:text-gray-900"
              }
            >
              Home
            </NavLink>
