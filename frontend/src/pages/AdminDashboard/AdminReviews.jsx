...
import { Loader2, Star, ArrowLeft, Pencil, Trash, X } from 'lucide-react';
...
// //           <div className='flex'>
// //             {/* Profile avatar */}
// //             <div className='flex items-center justify-center w-12 text-xl text-gray-700 bg-gray-200 rounded-full aspect-square'>{review.user.firstName.charAt(0).toUpperCase()}{review.user.lastName.charAt(0).toUpperCase()}</div>
// //           </div>
// //           {/* Right */}
// //           <div>
...
// //           </div>
// //         </div>
// //         <div className='flex items-center my-2'>{renderStars()} <span className='ml-2 text-gray-600'>{review.rating}.0</span></div> 
// //         <p className='my-2'>{review.description}</p>
// //         <p className='text-sm text-gray-500 '><DateFormatter date={review.createdAt} /></p>
// //       </div>
// //     )
// //   }
// const ReviewsCard = ({ review }) => {
...
//       setIsEditing(false);
//       // You might want to trigger a refresh of the reviews list here
//     } catch (error) {
//       toast.error(error.message);
//     }
//   };
...
//     </div>) : (
//       <div className='flex'>
//         {(reviews.length == 0) && (<div className='my-8 ml-4'>No reviews yet.</div>)}
