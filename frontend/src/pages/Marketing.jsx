...
const Marketing = () => {
   ...
   const thisCat = categories.find((c)=>c.name === "Digital Marketing");
   const tasks = thisCat.tasks;
  return (
    <section>
        {/* Head div */}
        <div className='flex flex-col justify-center py-12 rounded-lg bg-gradient-to-r from-cyan-700 to-cyan-950'>
            <h1 className='font-bold text-center text-white sm:text-4xl'>Digital Marketing</h1>
            <h3 className='mt-4 text-center text-white sm:text-2xl'>Build your brand. Grow your business.</h3>
            <button className='px-8 py-2 mx-auto mt-8 font-semibold text-white uppercase border-2 border-white hover:bg-cyan-600'>Contact Us</button>
        </div>
